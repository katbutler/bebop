...
public class RdioExampleActivity extends AppCompatActivity implements RdioListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rdioexample);
        ...
        rdio = new Rdio(RdioConstants.CLIENT_ID, RdioConstants.CLIENT_SECRET, credential, getApplicationContext(), this);
    ...
    public void onApiServiceReady(RdioService apiService) {
        ...
        rdio.getPlayerManager().addPlayerListener(new PlayerListener() {
            ...
            public void onPlayStateChanged(PlayState playState) {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onPlayStateChanged " + playState);
            ...
            public void onPositionUpdate(int mSec) {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onPositionUpdate " + mSec);
            ...
            public void onPrepared() {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onPrepared. We can now access " + rdio.getPlayerManager().getCurrentTrack());
            ...
            public void onComplete() {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onComplete");
            ...
            public void onSeekStarted() {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onSeekStarted");
                timeProgress.setBackgroundColor(0xffff62ad);
            }

            @Override
            public void onSeekCompleted() {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onSeekCompleted " + rdio.getPlayerManager().getCurrentPosition() + " / " + rdio.getPlayerManager().getCurrentDuration());
                timeProgress.setBackgroundColor(0x00ffffff);
            }

            @Override
            public void onError(AudioError error) {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onError " + error + " : " + error.getDescription());
            }

            @Override
            public void onBufferingStarted() {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onBufferingStarted");
                timerInfo.setBackgroundColor(0xffff7828);
            }

            @Override
            public void onBufferingEnded() {
                Log.i(LOG_NAME, ">>> RdioExampleActivity onBufferingEnded");
    ...
    public void login(View source) {
        try {
            ...
            Intent myIntent = new Intent(RdioExampleActivity.this, OAuth2WebViewActivity.class);
            myIntent.putExtra(OAuth2WebViewActivity.EXTRA_AUTH_URL, rdio.getAuthUrl(RdioConstants.REDIRECT_URI));
            myIntent.putExtra(OAuth2WebViewActivity.EXTRA_REDIRECT_URI, RdioConstants.REDIRECT_URI);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == AUTH_ACTIVITY_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            apiService.processWebViewActivity(data, RdioConstants.REDIRECT_URI);
